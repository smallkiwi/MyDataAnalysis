...
class NeuralNetwork(object):
    ...
    def init_weights_from_inputs_to_hidden_layer_neurons(self, hidden_layer_weights):
        weight_num = 0
        for h in range(len(self.hidden_layer.neurons)):  # 隐含层神经元的个数
    ...
    def init_weights_from_hidden_layer_neurons_to_output_layer_neurons(self, output_layer_weights):
        weight_num = 0
        for o in range(len(self.output_layer.neurons)):  # 输出层神经元的个数
    ...
    def train(self, training_inputs, training_outputs):
        ...
        # 反向传播
        # 1. 输出神经元的值
        pd_errors_wrt_output_neuron_total_net_input = [0] * len(self.output_layer.neurons)  # 输出层神经元的个数
    ...
    def calculate_total_error(self, training_sets):
        ...
        # 输出预测结果
        print(self.output_layer.get_outputs())
